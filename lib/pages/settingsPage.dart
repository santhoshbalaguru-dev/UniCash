...
import 'package:unicash/pages/billSplitter.dart';
import 'package:unicash/pages/budgetsListPage.dart';
import 'package:unicash/pages/creditDebtTransactionsPage.dart';
import 'package:unicash/pages/editHomePage.dart';
import 'package:unicash/pages/editObjectivesPage.dart';
import 'package:unicash/pages/homePage/homePageNetWorth.dart';
import 'package:unicash/pages/objectivesListPage.dart';
import 'package:unicash/pages/premiumPage.dart';
import 'package:unicash/pages/transactionsListPage.dart';
import 'package:unicash/pages/upcomingOverdueTransactionsPage.dart';
import 'package:unicash/struct/currencyFunctions.dart';
import 'package:unicash/struct/defaultPreferences.dart';
import 'package:unicash/struct/languageMap.dart';
import 'package:unicash/struct/navBarIconsData.dart';
import 'package:unicash/widgets/animatedExpanded.dart';
import 'package:unicash/widgets/dropdownSelect.dart';
import 'package:unicash/widgets/exportDB.dart';
import 'package:unicash/widgets/importCSV.dart';
import 'package:unicash/widgets/exportCSV.dart';
import 'package:unicash/pages/autoTransactionsPageEmail.dart';
import 'package:unicash/pages/activityPage.dart';
import 'package:unicash/pages/editAssociatedTitlesPage.dart';
import 'package:unicash/pages/editBudgetPage.dart';
import 'package:unicash/pages/editCategoriesPage.dart';
import 'package:unicash/pages/editWalletsPage.dart';
import 'package:unicash/pages/notificationsPage.dart';
import 'package:unicash/pages/subscriptionsPage.dart';
...
import 'package:unicash/widgets/notificationsSettings.dart';
...
import 'package:unicash/widgets/radioItems.dart';
import 'package:unicash/widgets/ratingPopup.dart';
import 'package:unicash/widgets/restartApp.dart';
import 'package:unicash/widgets/selectAmount.dart';
import 'package:unicash/widgets/selectColor.dart';
import 'package:unicash/widgets/settingsContainers.dart';
import 'package:unicash/pages/walletDetailsPage.dart';
import 'package:unicash/struct/initializeBiometrics.dart';
import 'package:unicash/widgets/sliderSelector.dart';
import 'package:unicash/widgets/tappable.dart';
import 'package:unicash/widgets/textWidgets.dart';
import 'package:unicash/widgets/util/checkWidgetLaunch.dart';
...
import 'package:unicash/auth/widgets/google_account_login_button.dart';
import 'package:unicash/auth/services/backup_recovery_service.dart';
import 'package:unicash/auth/widgets/backup_reminder.dart';
          ...
          if (hasSideNavigation == false)
            Row(
              ...
              children: [
                Expanded(
                  child: SettingsContainerOpenPage(
                    openPage: ObjectivesListPage(backButton: true),
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: SettingsContainerOpenPage(
                    ...
                    openPage:
                        appStateSettings["customNavBarShortcut0"] !=
                                "budgets" &&
...
Future<String> enterNameBottomSheet(
  context, {
  bool updatePageWhenSet = true,
}) async {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Builder(
          builder: (context) {
            late Color? selectedColor = HexColor(
...
class _ThemeSettingsDropdownState extends State<ThemeSettingsDropdown> {
  ...
  Widget build(BuildContext context) {
    return SettingsContainerDropdown(
      ...
      initial:
          appStateSettings["theme"].toString() == "black" &&
          ...
          descriptionWidget: Container(
            ...
            child: SliderTheme(
              ...
              child: SliderSelector(
                min: 0,
                max: 1,
                initialValue: (appStateSettings["widgetOpacity"] ?? 1)
                    .toDouble(),
                onChange: (value) {},
                divisions: 20,
                onFinished: (value) {
        ...
        authAvailable || isLocked
            ? SettingsContainerSwitch(
                ...
                onSwitched: (value) async {
                  AuthResult authResult = await checkBiometrics(
                    checkAlways: true,
                  );
                  if (authResult == AuthResult.error) {
                    openPopup(
                      ...
                      onCancelLabel: getPlatform() == PlatformOS.isIOS
                          ? "ok".tr()
                          : null,
                      onCancel: () {
                        popRoute(context);
    ...
    return SettingsContainerDropdown(
      ...
      onChanged: (value) async {
        if (value == "rounded") {
          ...
          await updateSettings("outlinedIcons", true, updateGlobalState: false);
        }
      ...
      initial: appStateSettings["outlinedIcons"] == true
          ? "outlined"
          : "rounded",
      title: "icon-style".tr(),
      icon: appStateSettings["outlinedIcons"]
  ...
  Widget build(BuildContext context) {
    return SettingsContainerDropdown(
      ...
      initial: appStateSettings["appAnimations"] == AppAnimations.all.index
          ...
          ? "minimal"
          : appStateSettings["appAnimations"] == AppAnimations.disabled.index
          ? "disabled"
          : "all",
    ...
    return SettingsContainer(
      ...
      afterWidget: Tappable(
        ...
        child: Padding(
          ...
          child: Builder(
            builder: (context) {
              String displayFontName = fontNameDisplayFilter(
                appStateSettings["font"].toString(),
              );
              return TextFont(text: displayFontName, fontSize: 14);
            },
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return SettingsContainer(
      ...
      onTap: () async {
        ...
        await openBottomSheet(context, fullSnap: true, SetNumberFormatPopup());
        String newSetting =
            appStateSettings["customNumberFormat"].toString() +
            appStateSettings["numberFormatDelimiter"].toString() +
            appStateSettings["numberFormatDecimal"].toString() +
              ...
              children: [
                Expanded(
                  child: OutlinedButtonStacked(
                    ...
                    text: "custom".tr(),
                    afterWidget: CustomNumberFormatPopup(
                      onChangeAnyOption: () {
                        updateSettings(
                          "customNumberFormat",
                          true,
...
class NumberPadFormatSetting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SettingsContainer(
      ...
      onTap: () {
        openBottomSheet(context, NumberPadFormatSettingPopup());
      },
      icon: appStateSettings["outlinedIcons"]
          ? Icons.dialpad_sharp
    ...
    return PopupFramework(
      ...
      child: Column(
        children: [
          ...
          NumberPadHapticFeedbackSetting(enableBorderRadius: true),
          HorizontalBreak(),
          SizedBox(height: 10),
              ...
              child: AnimatedOpacity(
                ...
                child: OutlinedButtonStacked(
                  ...
                  onTap: () {
                    ...
                    updateSettings(
                      "numberPadFormat",
                      NumberPadFormat.format123.index,
                      updateGlobalState: false,
                    );
                  },
                ),
              ...
              child: AnimatedOpacity(
                ...
                child: OutlinedButtonStacked(
                  ...
                  onTap: () {
                    ...
                    updateSettings(
                      "numberPadFormat",
                      NumberPadFormat.format789.index,
                      updateGlobalState: false,
                    );
                  },
                ),
