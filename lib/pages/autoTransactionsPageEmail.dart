...
import 'package:unicash/pages/addEmailTemplate.dart';
...
import 'package:unicash/widgets/statusBox.dart';
              ...
              Padding(
                ...
                child: Tappable(
                  ...
                  color:
                      ...
                      ? Theme.of(
                          context,
                        ).colorScheme.selectableColorRed.withOpacity(0.5)
                      : doesEmailContain
                      ? Theme.of(
                          context,
                        ).colorScheme.selectableColorGreen.withOpacity(0.5)
